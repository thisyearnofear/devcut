...
MODES = (
    ...
    "  After stitch: output a Builder Kit in chat — shot list, HyperFrames\n"
    "  BRIEF.md seed bullets (workflow: product-launch-video or general-video),\n"
    "  and 3 non-goals. Do NOT invent sci-fi or consumer creator stories.\n"
    "\n"
    "SUBMIT READY (builder — Mode: Submit Ready):\n"
    "  Job: Devpost / launch demo cut for a repo, product URL, or HyperFrames note.\n"
    ...
    "GitHub repo, or 'Devpost demo', treat as Submit Ready.\n"
)
...
WORKFLOW = (
    ...
    "6. Challenge Cut only: Builder Kit summary in chat.\n"
    "\n"
    "GUIDELINES:\n"
