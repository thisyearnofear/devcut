...
MODES = (
    ...
    "  Shot grammar: Logo reveal → Feature hero ×3 → Social proof/metric → CTA.\n"
    "  Constraint rules:\n"
    "  - All on-screen text must be spelled verbatim with exact case; no accidental characters or symbols.\n"
    ...
    "  - Background layer: repeating outline text flowing horizontally at ultra-low speed.\n"
    ...
    "If the brief mentions 'product launch', 'demo video', 'founder', 'PM', or\n"
    "reads like a marketing brief (no hackathon context), treat as Product Cut.\n"
)
